...
⧖t₀=13.8×10⁹y<br>
⧖R_h=46.5×10⁹ly (particle_horizon; comoving)<br>
⧖D_h=93×10⁹ly (diameter; comoving)<br>
...
quantum_fluctuation=microscopic_noise<br>
dark_energy=macroscopic_vacuum_pressure<br>
vacuum∅ → δq_fluctuation → inflation↑ → hot_dense_state(BigBang)<br>
<br>
...
⟟BH_geo:<br>
acc_disk≈1–4ly<br>
corona≈days–months<br>
jets⊥disk (→10⁵–10⁶ly)<br>
